...
class AnimateFromCoeff():
    ...
    def generate(self, x, video_save_dir, pic_path, crop_info, enhancer=None, background_enhancer=None, preprocess='crop', img_size=256):
        ...
        print(f'The animated video is named {video_save_dir}/{video_name}')
        ...
        if 'full' in preprocess.lower():
            ...
            print(f'The full (preproc animated video is named {video_save_dir}/{video_name_full}')
        else:
        ...
        if enhancer:
            ...
            print(f'The enhanced video is named {video_save_dir}/{video_name_enhancer}')
